...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <div class="page-container">
            ...
            <!-- MAIN CONTENT-->
            <div class="main-content"style="background: url('images/apart11.jpg');background-size: 115%">
 ...
 ?>                       
                        ...
                        <div class="row m-t-25">
                             <div class="col-sm-6 col-lg-3">
                                <div class="overview-item overview-item--c1"style="background-image: -webkit-linear-gradient(90deg, #0000 0%, #5B5B5B 0%);">
...
$count_yesterday_visitors=mysqli_num_rows($query1);
 ?>                       
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="overview-item overview-item--c2"style="background-image: -webkit-linear-gradient(90deg, #0000 0%, #5B5B5B 0%);">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            <div class="icon">
                                                     <i class="zmdi zmdi-account-o"></i>
...
$count_lastsevendays_visitors=mysqli_num_rows($query2);
 ?>                       
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="overview-item overview-item--c3"style="background-image: -webkit-linear-gradient(90deg, #0000 0%, #5B5B5B 0%);">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            <div class="icon">
                                                <i class="zmdi zmdi-account-o"></i>
...
$count_total_visitors=mysqli_num_rows($query3);
 ?>                       
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="overview-item overview-item--c4"style="background-image: -webkit-linear-gradient(90deg, #0000 0%, #5B5B5B 0%);">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            <div class="icon">
                                            <i class="zmdi zmdi-account-o"></i>
