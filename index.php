...
<head>
    ...
    <!-- Title Page-->
    <title>Apartment Visitors Management Login</title>
...
<body class="animsition">
    <div class="page-wrapper">
        <div class="page-content--bge5"style="background: url('images/apart1.jpg');background-size: 100%;margin:0%;">
            <div class="container">
                <div class="login-wrap">
                    <div class="login-content"style=" background: #120a0abd; margin: top -10px;">
                        <div class="login-logo">
                            <a href="index.php" style="font-size:24px;">
                            Apartment Visitors Management (AVM)
                            </a>
                        </div>
